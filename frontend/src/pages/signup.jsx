...
const Signup = () => {
    ...
    // Add validation for vehicleNumber (example: must match a pattern like DL12AB1234)
    ...
    const handleSubmit = async (e) => {
        ...
        if (role === 'driver') {
            ...
            if (!validateVehicleNumber(formData.vehicleNumber)) {
                setError('Vehicle number must follow the format: XX12XX1234 (e.g., DL12AB1234).');
                setIsLoading(false);
                return;
            }
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (response.status === 400) {
                    throw new Error(data.msg || 'Bad request: Invalid or missing data in the request.');
                } else if (response.status === 500) {
                    throw new Error(data.msg || 'Server error: Something went wrong on the server.');
                } else {
            ...
            console.error('Signup error:', err, { response: err.response, data });
                    ...
                    <div className="max-w-md mx-auto w-full">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full pl-10 pr-12 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm text-purple-600 hover:text-purple-700 font-medium">Terms & Conditions</a>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full bg-purple-600 text-white py-2.5 rounded-lg font-medium hover:bg-purple-700 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50"
                            >
                                {isLoading ? (
                            ...
                            <p className="text-center text-sm text-gray-600 pt-2">
                                ...
                                <Link to="/login" className="text-purple-600 hover:text-purple-700 font-medium">Log in</Link>
                            </p>
                        </form>
                    </div>
                </div>
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-center">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-lg mb-1">Real-time Tracking</h4>
                                    <p className="text-purple-100">Monitor your shipments 24/7 with live updates</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="bg-white/20 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-purple-100">Deliver to over 200+ countries worldwide</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="bg-white/20 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p className="text-purple-100">99.9% on-time delivery guarantee</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="bg-white/20 p-3 rounded-lg">
                                ...
                                <div>
                                    <h4 className="font-semibold text-lg mb-1">Secure & Insured</h4>
                                    <p className="text-purple-100">Full insurance coverage for all shipments</p>
                                </div>
                            </div>
                        </div>
                    </div>
